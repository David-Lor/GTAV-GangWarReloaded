    ...
    {   
        ...
        if (IsSpawnLocADefined && IsSpawnLocBDefined)
        {
            ...
            if (team == "A")
            {
                ...
                //Relationship&weapon TEAM A-enemy
                if (ped != null)
                {                    
            ...
            {                
                ...
                //Relationship&weapon TEAM B-ally
                if (ped != null)
                {                    
            ...
            UI.Notify("Press H = TeamA (Enemies) or J = Team B (Allies) to define the teams spawnlocation at your actual position");
    }
